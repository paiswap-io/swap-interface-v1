...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@alex_7/sdk'
...
describe('utils', () => {
  describe('#getBscScanLink', () => {
    ...
    it('enum', () => {
      expect(getBscScanLink(ChainId.MAINNET_CHILD_0, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
  })

  describe('#calculateSlippageAmount', () => {
    it('bounds are correct', () => {
      const tokenAmount = new TokenAmount(new Token(ChainId.MAINNET_CHILD_0, AddressZero, 0), '100')
